...
exports.resizeTourImages = catchAsync(async (req, res, next) => {
  ...
  // await Promise.all because without it, the next() would be called without waiting for the forEach (now map) to finish
  // req.files.images.map will return an array of Promises
  await Promise.all(
...
exports.getToursWithin = catchAsync(async (req, res, next) => {
  ...
  if (!lat || !lng)
    next(
      new AppError(
        'Please provider latitude and longitude in the format lat, lng.',
        400,
      ),
    );
